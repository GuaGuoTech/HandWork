...
namespace HandWork.Com.Service.Weixins
{
    public class WeixinService
    {
     ...
     private static readonly string _url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wxd21f90079ecb0969&secret=338345d734124088ce5579a6a4514318";
     ...
     public static string CreateWenxinMenu()
     {
        ...
        HttpWebResponse _response =null;
         ...
         //如果需要POST数据     
             ...
             string buffer = "{'button':[{'type':'click','name':'测试','key':'V1001_TODAY_MUSIC'},{'name':'测试','sub_button':[{'type':'view','name':'测试','url':'http://120.27.104.135/'}, { 'type':'view','name':'test','url':'http://v.qq.com/' },{ 'type':'click','name':'测试','key':'V1001_GOOD' }]}]}";
             ...
             return GetStream(_response, Encoding.UTF8);
     }
